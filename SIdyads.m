function total_accuracy = SIdyads(subj_number, run_number, win, dispSize, break_frequency, iti_length, send_trig)
...
for itrial = 1:n_trials
    ...
    keyPressed = 0; %Whether a key has been pressed
